<?php 
    ...
    $format2="<p>
                We're excited to inform you that the book you've been eagerly waiting for is now available on Book Pedlar! 📚
            </p>
            <h3>Book Details:</h3>";

    $format3="<p>
                <strong>Negotiate and Purchase:</strong> If you're interested in purchasing the book, you can start a conversation with the seller to negotiate the price and arrange for the pickup or delivery. Simply log in to your Book Pedlar account and visit the book's page to initiate the conversation.
            </p>
            <p>
                <strong>Act Fast!</strong> Books on Book Pedlar sell quickly, so don't miss this opportunity to grab your copy!
            </p>
            <p>
                Happy Reading! 📖
            </p>
            <p>
                Warm Regards,<br>Paras Sachdeva<br>Book Pedlar Team
            </p>
        </div>
      </body>
    </html>";
